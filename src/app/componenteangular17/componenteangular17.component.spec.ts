...
import { Componenteangular17Component } from './componenteangular17.component';
...
describe('Testando componente 17', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [Componenteangular17Component]
    }).compileComponents();
  });
  ...
  it('Validar variável nome', () => {
    ...
    // Fixture
    const fixture = TestBed.createComponent(Componenteangular17Component);

    // Obter as variáveis e funções do componente
    const componente = fixture.componentInstance;

    // Validação
    expect(componente.nome).toEqual('Toni');
